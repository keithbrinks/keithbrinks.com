                ...
                <section class="flex flex-col md:flex-row-reverse">
                    ...
                    <div>
                        <p class="text-xl mb-6">
                            Hi, I'm Keith. With over {{ $experience }} years of IT experience, I lead IT for a global manufacturing company based in West Michigan. My goal is to simplify every aspect of IT and develop a world-class team who delivers exceptional value through lean and agile methodologies.
                        </p>
                        <p class="text-xl">
